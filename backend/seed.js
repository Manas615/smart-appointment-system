...
const baseProviders = [
  ...
  },
  {
    ...
    bio: "Fellowship-trained neurologist specializing in epilepsy and stroke management.",
  },
  {
    name: "Dr. Rahul Verma",
    specialty: "ENT",
    ...
    bio: "ENT surgeon with 12 years of experience in sinus and ear surgeries.",
  },
  {
    ...
    bio: "Expert ophthalmologist specializing in cataract and LASIK surgery.",
  },
  {
    name: "Dr. Deepak Joshi",
    specialty: "Psychiatry",
    email: "deepak.joshi@clinic.com",
    phone: "+91 98765 43219",
    bio: "Experienced psychiatrist offering comprehensive mental health care.",
  },
  {
    name: "Dr. Aarti Desai",
    specialty: "Gynecology",
    email: "aarti.desai@clinic.com",
    phone: "+91 98765 43220",
    bio: "Renowned gynecologist with expertise in high-risk pregnancies and minimally invasive surgery.",
  },
];
...
for (const specialty of Object.keys(specialtyServices)) {
  ...
  for (let i = 0; i < 15; i++) {
    ...
    const bio =
      bios[i % bios.length] ||
      `Experienced specialist in ${specialty}. Dedicated to providing excellent patient care and clinical outcomes.`;
    providers.push({
      name: `Dr. ${fName} ${lName}`,
      specialty: specialty,
...
for (const slot of randomSlotsToFill) {
  ...
  if (service) {
    ...
    const pEmail =
      pName.split(" ")[0].toLowerCase() + Math.floor(Math.random() * 100) + "@example.com";
...
console.log(
  `   - ${providers.length} providers (${Object.keys(specialtyServices).length} specialties)`
);
