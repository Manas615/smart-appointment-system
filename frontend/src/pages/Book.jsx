            ...
            <div className="page-container">
                <div className="booking-success">
                    ...
                    <div className="success-details">
                        ...
                        <p><strong>Service:</strong> {success.service_name}</p>
                        <p><strong>Date:</strong> {success.date}</p>
                        <p><strong>Time:</strong> {success.start_time} – {success.end_time}</p>
                        <p><strong>Patient:</strong> {success.patient_name}</p>
        ...
        <div className="page-container">
            ...
            {step === 1 && (
                <div className="booking-step">
                    ...
                    <p className="step-context">Provider: <strong>{form.provider?.name}</strong></p>
                    {loading ? (
            ...
            {step === 3 && (
                <div className="booking-step">
                    ...
                    <div className="booking-summary">
                        ...
                        <div className="summary-row">
                            <span>Time</span>
                            <span>{form.slot?.start_time} – {form.slot?.end_time}</span>
                        </div>
