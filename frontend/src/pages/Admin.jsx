                    ...
                    <tbody>
                        {providers.map((p) => (
                            <tr key={p.id}>
                                <td>#{p.id}</td>
                                <td>{p.name}</td>
                                <td><span className="specialty-tag">{p.specialty}</span></td>
                                <td>{p.email}</td>
                                <td>{p.phone || "—"}</td>
                                <td>
...
function ReportsTab() {
    ...
    if (!report) return <div className="empty-state"><p>Could not load reports</p></div>;
        ...
        <div className="reports-grid">
            ...
            <div className="report-panel">
                ...
                <div className="timeline-chart">
                    {report.bookingsByDate.slice(0, 14).reverse().map((d) => (
